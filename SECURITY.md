...
- [Security Insights Specification](https://github.com/open-nudge/comver/blob/main/SECURITY-INSIGHTS.yml)
...
- [Renovate Bot](https://github.com/open-nudge/comver/blob/main/.github/renovate.json)
    for automated dependency updates
- [Software Bills Of Material (SBOMs)](https://github.com/open-nudge/comver/releases)
- [Sigstore signing](https://github.com/open-nudge/comver/releases)
